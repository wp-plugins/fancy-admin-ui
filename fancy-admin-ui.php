...
function fau_admin_theme_style() {
  wp_enqueue_style( 'fau-admin-theme', plugins_url( 'css/fau-styles-admin.php', __FILE__ ) );
  wp_enqueue_style( 'fau-adminbar', plugins_url( 'css/fau-styles-adminbar.php', __FILE__ ) );
}
